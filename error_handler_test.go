...
func TestDefaultErrorHandler(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			wantWWWAuthenticate:  `Bearer realm="api", error="invalid_token", error_description="The access token is malformed"`,
		},
		{
			name:                 "invalid issuer",
			...
			wantWWWAuthenticate:  `Bearer realm="api", error="invalid_token", error_description="The access token was issued by an untrusted issuer"`,
		},
		{
